...
app.post("/edit/:id", async (req, res) => {
  ...
  const new_summary = req.body.summary;
  // const new_note = req.body.new_note; 

  // Update all fields except notes
  await db.query(
    "UPDATE books SET isbn = $1, title = $2, author = $3, date_read = $4, rating = $5, summary = $6 WHERE id = $7",
    [new_isbn, new_title, new_author, new_date_read, new_rating, new_summary, bookId]
  );
